(ns auto-core.keyword-test
  (:require [auto-core.keyword :as sut]
...
(deftest sanitize-map-keys-test
  (testing "Basic case"
    (is (= {:hello "world", :my-amazing :liFe}
           (sut/sanitize-map-keys {:heLLo "world", :my_amazing :liFe}))))
  (testing "Works on nested maps"
    (is (= {:hello "world",
            :my-amazing :liFe,
            :three {:two-more {:another-one 1, :normal-one :true}, :one "hi"}}
